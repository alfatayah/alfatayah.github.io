...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_D_Repo_alfatayah_github_io_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_D_Repo_alfatayah_github_io_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_D_Repo_alfatayah_github_io_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_D_Repo_alfatayah_github_io_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_D_Repo_alfatayah_github_io_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
if((external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default()).captureOwnerStack){// React 19+ approach
const ownerStack=external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().captureOwnerStack();const currentStack=new Error().stack||``;fullStack=ownerStack?`${currentStack}\n${ownerStack}`:currentStack;}else if((_React$__SECRET_INTER=(external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default()).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED)!==null&&_React$__SECRET_INTER!==void 0&&(_React$__SECRET_INTER2=_React$__SECRET_INTER.ReactDebugCurrentFrame)!==null&&_React$__SECRET_INTER2!==void 0&&_React$__SECRET_INTER2.getCurrentStack){// React 18 approach
fullStack=external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();}else{// Fallback if neither API is available
...
var _react = _interopRequireDefault(__webpack_require__(3464));
...
var React = __webpack_require__(3464);
...
var React = _interopRequireWildcard(__webpack_require__(3464));
...
"use strict";
module.exports = require("D:\\Repo\\alfatayah.github.io\\node_modules\\react\\index.js");
...
var _react = __webpack_require__(3464);
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(3464));var _gatsby=__webpack_require__(123);var _common=__webpack_require__(1854);var _getManifestPathname=_interopRequireDefault(__webpack_require__(4598));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
module.exports = require("D:\\Repo\\alfatayah.github.io\\.cache\\ssr-builtin-trackers\\fs");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3464);
...
const isHeadRenderFromContext=external_D_Repo_alfatayah_github_io_node_modules_react_index_js_default().useContext(IsHeadRenderContext);return isHeadRenderFromContext;}function htmlOrBodyComponentFactory(TagName){const HeadAwareComponent=props=>{// De-risk monkey patch by only applying it within a `Head()` render.
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(4858),options:{"plugins":[],"name":"gatsby-starter-default","short_name":"starter","start_url":"/","background_color":"#663399","theme_color":"#663399","display":"minimal-ui","icon":"src/images/favicon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"72b0f49c2765889134e5fa58a8480e27"}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + ({"125":"component---src-pages-404-js","293":"component---src-pages-index-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
